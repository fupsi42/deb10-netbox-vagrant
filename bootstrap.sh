...
# Update Debian
printf "Step 1 of 19: Updating Debian..."
apt-get update -y > /dev/null

# Install dependencies for System
printf "Step 1.1 of 19: Updating Debian..."
apt-get install git ifupdown2 -y > /dev/null
...
printf "Step 11 of 19: Copy 00-asliases.sh..."
cp /vagrant/00-aliases.sh /etc/profile.d/00-aliases.sh
...
# Status Complete
printf "%s\nCOMPLETE: Debian10 Provisioning COMPLETE!!"
